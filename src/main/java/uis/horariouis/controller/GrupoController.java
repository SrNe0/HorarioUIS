...
public class GrupoController {
    ...
    @Operation(summary = "Obtener todos los grupos",
            description = "Obtiene una lista de todos los grupos disponibles.")
    @GetMapping()
    ...
    @GetMapping("/{id}")
    public Optional<Grupo> getGrupoById(@Parameter(description = "ID del grupo a buscar", required = true)
                                        @PathVariable Long id) {
        return grupoService.getGrupoById(id);
    }

    @Operation(summary = "Eliminar un grupo por su ID",
            description = "Elimina un grupo existente por su ID.")
    @ApiResponse(responseCode = "204", description = "Grupo eliminado exitosamente")
    @DeleteMapping("/{id}")
    public void deleteGrupo(@Parameter(description = "ID del grupo a eliminar", required = true)
                            @PathVariable Long id) {
        grupoService.deleteGrupo(id);
    }

    @Operation(summary = "Crear un nuevo grupo",
            description = "Crea un nuevo grupo a partir de los datos proporcionados en el DTO.")
    ...
    @PostMapping("/")
    public ResponseEntity<Grupo> createGrupo(@Parameter(description = "Datos del nuevo grupo", required = true)
    ...
    @Operation(summary = "Actualizar un grupo existente",
            description = "Actualiza un grupo existente por su ID utilizando los datos proporcionados en el DTO.")
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Grupo> updateGrupo(@Parameter(description = "ID del grupo a actualizar", required = true)
                                             @PathVariable Long id,
    ...
    @Operation(summary = "Exportar asignaturas a un archivo CSV", description = "Exporta grupos a un archivo CSV.")
